...
const SkillSchema = new mongoose.Schema(
  {
    ...
    level: { type: Number, required: true, default: 60, min: 0, max: 100 }, // 0-100 scale
    difficulty: { type: Number, default: 1, min: 1, max: 10 }, // 1-10 scale
    category: { type: String, default: "General", trim: true },
    experience: { type: String, default: "0 months", trim: true },
    usedInProjects: { type: Number, default: 0, min: 0 },
